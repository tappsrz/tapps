function createUnityInstance(t, n, c) {
    ...
    function e(e, t, n) {
        var r = e[t];
        void 0 !== r && r || (console.warn(
            'Config option "' + t +
            '" is missing or empty. Falling back to default value: "' + n + '". Consider up' +
            'dating your WebGL template to include the missing config option.'
        ), e[t] = n)
    }
    c = c || function () {};
    var o,
        l = {
            ...
            printErr: function (e) {
                console.error(e),
                "string" == typeof e && -1 != e.indexOf("wasm streaming compile failed") && (
                    -1 != e.toLowerCase().indexOf("mime")
                        ? s(
                            'HTTP Response Header "Content-Type" configured incorrectly on the server for f' +
                                    'ile ' + l.codeUrl + ' , should be "application/wasm". Startup time performance' +
                                    ' will suffer.',
                            "warning"
                        )
                        : s(
                            'WebAssembly streaming compilation failed! This can happen for example if "Cont' +
                                    'ent-Encoding" HTTP header is incorrectly enabled on the server for file ' + l.codeUrl +
                                    ", but the file is not pre-compressed on disk (or vice versa). Check the Networ" +
                                    "k tab in browser Devtools to debug server header configuration.",
                            "warning"
                        )
                )
            },
    ...
    l
        ...
        .push(function () {
            for (
                var e in l.disableAccessToMediaDevices(),
                a.forEach(function (e) {
            ...
            l.startupErrorHandler
                ...
                : l.errorHandler && l.errorHandler(e, t, n) || (
                    ...
                    D.didShowErrorMessage || (
                        -1 != (e = "An error occurred running the Unity content on this page. See your browser Jav" +
                                "aScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING")
                                ? e = "An exception has occurred, but exception handling has been disabled in this bu" +
                                                "ild. If you are the developer of this content, enable exceptions in your proje" +
                                                "ct WebGL player settings to be able to catch the exception or see the stack tr" +
                                                "ace."
                                : -1 != e.indexOf("Cannot enlarge memory arrays")
                                    ? e = "Out of memory. If you are the developer of this content, try allocating more m" +
                                                    "emory to your WebGL build in the WebGL player settings."
                                    : -1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf(
                                        "Invalid typed array length"
                                    ) && -1 == e.indexOf("out of memory") && -1 == e.indexOf(
                                        "could not allocate memory"
                                    ) || (
                                        e = "The browser could not allocate enough memory for the WebGL content. If you are" +
                                        " the developer of this content, try allocating less memory to your WebGL build" +
        ...
        if ("symbolsUrl" != e) {
            var n = l.downloadProgress[e],
                r = (n = n || (l.downloadProgress[e] = {
                    ...
                    total: 0,
                    loaded: 0
                }), "object" != typeof t || "progress" != t.type && "load" != t.type || (
    ...
    function T() {
        new Promise(function (a, e) {
                    ...
                    for (e in t) {
                        ...
                        if (l.frameworkUrl.endsWith("." + r[0])) 
                            ...
                            "file:" == location.protocol
                                ? void s(
                                    n + " Loading pre-compressed (brotli or gzip) content via a file:// URL without" +
                                            " a web server is not supported by this browser. Please use a local development" +
                                            " web server to host compressed Unity content, or use the Unity Build and Run o" +
                                            "ption.",
                                    "error"
                                )
                                : (
                                    n += ' This can happen if build compression was enabled but web server hosting the c' +
                                            'ontent was misconfigured to not serve the file with HTTP Response Header "Cont' +
                                            'ent-Encoding: ' + r[1] + '" present. Check browser Console and Devtools Networ' +
                                            'k tab to debug.',
                                    "br" == r[0] && "http:" == location.protocol && (
                                        r = -1 != ["localhost", "127.0.0.1"].indexOf(location.hostname)
                                            ? ""
                                            : "Migrate your server to use HTTPS.",
                                        n = /Firefox/.test(navigator.userAgent)
                                            ? "Unable to parse " + l.frameworkUrl + '!<br>If using custom web server, verify ' +
                                                    'that web server is sending .br files with HTTP Response Header "Content-Encodi' +
                                                    'ng: br". Brotli compression may not be supported in Firefox over HTTP connecti' +
                                                    'ons. ' + r + ' See <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=16706' +
                                                    '75">https://bugzilla.mozilla.org/show_bug.cgi?id=1670675</a> for more informat' +
                                                    'ion.'
                                            : "Unable to parse " + l.frameworkUrl + '!<br>If using custom web server, verify ' +
                                                    'that web server is sending .br files with HTTP Response Header "Content-Encodi' +
                                                    'ng: br". Brotli compression may not be supported over HTTP connections. Migrat' +
                                                    'e your server to use HTTPS.'
                                    ),
                                    void s(n, "error")
                                )
                        }
                    s(
                        "Unable to parse " + l.frameworkUrl + "! The file is corrupt, or compression wa" +
                                "s misconfigured? (check Content-Encoding HTTP Response Header on web server)",
                        "error"
                    )
                }
            ...
            i.onerror = function (e) {
                s(
                    "Unable to load file " + l.frameworkUrl + "! Check that the file exists on the " +
                            "remote server. (also check browser Console and Devtools Network tab to debug)",
                    "error"
                )
            },
            document
        ...
        var n,
            ...
            o = t(l[n], {
                ...
                .catch(function (e) {
                    ...
                    "file:" == location.protocol
                        ? s(
                            t + ". Loading web pages via a file:// URL without a web server is not supporte" +
                                    "d by this browser. Please use a local development web server to host Unity con" +
                                    "tent, or use the Unity Build and Run option.",
                            "error"
                        )
                        : console.error(t)
                });
        ...
        var d,
            ...
            h = (
                (h = document.createElement("canvas")) && (
                    ...
                    f && (
                        r = f.getExtension("WEBGL_debug_renderer_info") && f.getParameter(37446) || f.getParameter(7937)
                    )
                ),
    ...
    l.readBodyWithProgress = function (a, i, s) {
        ...
        return c || console.warn(
            "[UnityCache] Response is served without Content-Length header. Please reconfig" +
            "ure server to include valid Content-Length for better download performance."
        ),
        function o() {
            return void 0 === e
                ? a
                ...
                : e
                    ...
                    .then(function (e) {
                        ...
                        return h + e.value.length <= d.length
    ...
    l.UnityCache = (
        ...
        x.prototype.clearCache = function () {
            ...
            return this
                ...
                .then(function e(t) {
                    ...
                    return 0 === t.length
                        ? Promise.resolve()
                        : (n = t.pop(), r.cache.delete(n).then(function () {
                            return e(t)
                        }))
                })
        },
        ...
        x.prototype.loadRequest = function (
            e
        ) {
            var t = this;
            return t
        ...
        x.prototype.upgradeDatabase = function (e) {
            ...
            e
                .objectStoreNames
                .contains(m) && e.deleteObjectStore(m),
            e
                .objectStoreNames
            ...
            return this
                ...
                .then(function (e) {
                    ...
                    return function e() {
                        ...
                        return 0 === r.length
                            ? Promise.resolve()
                            : (t = r.pop(), i.cache.delete(t.url).then(function (e) {
                                if (e) 
                                    return r = t.url,
                                    new Promise(function (e, t) {
                                        var n = i
                                            .database
                                            .transaction([p.name], "readwrite");
                                        n
                                            .objectStore(p.name)
                                            .delete(r),
                                        n.oncomplete = e,
        ...
        function (o, a) {
                        ...
                        : 304 === e.status
                            ? (
                                ...
                                i.updateRequestMetaData(c.metaData).then(function () {
                                    E(
                                        "'" + c.metaData.url + "' successfully revalidated and served from the indexedD" +
                                        "B cache"
                                    )
                                }).catch(function (e) {
                                    E(
                                        "'" + c.metaData.url + "' successfully revalidated but not stored in the indexe" +
                                        "dDB cache due to the error: " + e
                                    )
                                }),
                                ...
                                ? (
                                    ...
                                    S(e, r.onProgress, r.enableStreamingDownload).then(function (e) {
                                        ...
                                        Promise
                                            ...
                                            .then(function () {
                                                E(
                                                    "'" + s + "' successfully downloaded and stored in the indexedDB cache"
                                                )
                                            })
                                            .catch(function (e) {
                                                E(
                                                    "'" + s + "' successfully downloaded but not stored in the indexedDB cache due " +
                                                    "to the error: " + e
                                                )
                                            }),
                                        e
            ...
            c.enabled
                ? i
                    ...
                    .catch(function (e) {
                        return E(
                            "Failed to load '" + c.metaData.url +
                            "' from indexedDB cache due to the error: " + e
                        ),
                        y(o, a)
                    })
                : y(o, a)
    ...
    new Promise(function (e, t) {
        ...
        l.SystemInfo.hasWebGL
            ? 1 == l.SystemInfo.hasWebGL
                ? (
                    n = 'Your browser does not support graphics API "WebGL 2" which is required for thi' +
                            's content.',
                ...
                : l.SystemInfo.hasWasm
                    ? (l.startupErrorHandler = t, c(0), l.postRun.push(function () {
                        c(1),
